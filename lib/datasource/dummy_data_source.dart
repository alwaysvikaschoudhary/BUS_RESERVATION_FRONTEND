...
import 'package:flutter_frontend/models/app_user.dart';
import 'package:flutter_frontend/models/auth_response_model.dart';
import 'package:flutter_frontend/models/bus_model.dart';
import 'package:flutter_frontend/models/bus_reservation.dart';
import 'package:flutter_frontend/models/bus_schedule.dart';
import 'package:flutter_frontend/models/bus_route.dart';
import 'package:flutter_frontend/models/response_model.dart';
...
class DummyDataSource extends DataSource{
  ...
  Future<BusRoute?> getRouteByCityFromAndCityTo(String cityFrom, String cityTo) async {
    BusRoute? route;
    try {
        route = TempDB.tableRoute.firstWhere( (r) => 
          r.cityFrom == cityFrom && r.cityTo == cityTo);
        return route;   
